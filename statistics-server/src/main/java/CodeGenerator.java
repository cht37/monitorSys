...
public class CodeGenerator {
    ...
    private  static void generate() throws IOException {
        ...
        String courseFile = "F:\\documents\\Work\\monitorSys\\statistics-server";
