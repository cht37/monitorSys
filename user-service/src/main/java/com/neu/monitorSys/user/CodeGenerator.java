...
public class CodeGenerator {
    ...
    private  static void generate() throws IOException {
        ...
        String courseFile = "F:\\documents\\Work\\monitorSys\\user-service";
...
//                    **********************必须修改的表名**************
                    builder.addInclude("member").addInclude("roles").addInclude("grid_manager");// 设置需要生成的表名
