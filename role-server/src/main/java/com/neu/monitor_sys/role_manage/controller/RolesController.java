package com.neu.monitor_sys.role_manage.controller;
...
public class RolesController {
    ...
    public MyResponse<Boolean> enableRole(@PathVariable Integer roleId,@RequestParam boolean enabled) {
        boolean result;
        try {
            result = rolesService.enableRole(roleId, enabled);
        } catch (Exception e) {
