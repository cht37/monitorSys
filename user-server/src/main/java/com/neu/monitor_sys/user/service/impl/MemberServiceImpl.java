...
import com.neu.monitor_sys.user.client.RoleClient;
import com.neu.monitor_sys.common.constants.UserRedisPrefix;
import com.neu.monitor_sys.user.mapper.MemberMapper;
import com.neu.monitor_sys.user.repository.UserDetailRepository;
import com.neu.monitor_sys.user.service.IMemberService;
...
public class MemberServiceImpl extends ServiceImpl<MemberMapper, Member> implements IMemberService {
    ...
    public MemberWithRole getMemberWithRole(String logId) {
       ...
       //遍历角色集合
        ...
        Integer sysState = memberMapper.getSysState(logId);
        ...
        memberWithRole.setAvailable(sysState);
...
//        List<Member> members = memberMapper.selectList(wrapper);
    ...
    @Override
    public boolean setState(String logId, Integer state) {
        UpdateWrapper<Member> updateWrapper = new UpdateWrapper<>();
        updateWrapper.eq("logid", logId);
        Member member = new Member();
        ...
        //删除redis缓存
        redisUtil.del(UserRedisPrefix.USER_DETAIL_PREFIX + logId);
        return true;
    }
