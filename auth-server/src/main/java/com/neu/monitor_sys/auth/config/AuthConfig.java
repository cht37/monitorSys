...
import com.neu.monitor_sys.auth.filter.JwtAuthenticationTokenFilter;
import com.neu.monitor_sys.auth.handler.AccessDeniedHandlerImpl;
import com.neu.monitor_sys.auth.handler.MyLogoutHandler;
import com.neu.monitor_sys.auth.handler.MyLogoutSuccessHandler;
import com.neu.monitor_sys.auth.manager.MyAccessManager;
import com.neu.monitor_sys.auth.service.impl.MyUserDetailsService;
...
public class AuthConfig extends SecurityConfigurerAdapter<DefaultSecurityFilterChain, HttpSecurity> {
    //5分钟
    public static long tokenExpireTime = 5 * 60 ;
    @Autowired
...
//    }
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        Set<String> permitAll = Set.of("/api/v1/auth/public/register", "/api/v1/auth/login", "/api/v1/code/sms", "/api/v1/auth/login/mobile","/api/v1/auth/normal/register", "/error","/api/v1/auth/logout");
