package com.neu.monitor_sys.notification.service.impl;

import cn.hutool.core.text.CharSequenceUtil;
import cn.hutool.core.util.StrUtil;
import com.neu.monitor_sys.common.constants.ResultCode;
import com.neu.monitor_sys.notification.service.NotificationService;
...
public class NotificationServiceImpl implements NotificationService {
  ...
  public SseEmitter createSseEmitter(String clientId) {
        ...
        log.info("创建连接：{}", clientId);
        return sseEmitter;
    }

    @Override
    public void sendMessageToOneClient(String clientId, String msg) {
         sendMsgToClientByClientId(clientId, msg, sseCache.get(clientId));
    }
     /**
     * 推送消息到客户端
    ...
    private void sendMsgToClientByClientId(String clientId, String msg, SseEmitter sseEmitter) {
        ...
        try {
            ...
            while (i < 5) {
                ...
                log.info("{}的第{}次消息重推成功,{}", clientId, i + 1, msg);
                return;
            }
        }
    }
