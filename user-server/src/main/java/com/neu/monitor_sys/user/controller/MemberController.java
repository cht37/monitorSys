package com.neu.monitor_sys.user.controller;
...
import com.neu.monitor_sys.user.constants.ResultCode;
...
//    @IgnoreToken(value = false)
     ...
     */
    @PutMapping("/state")
    public MyResponse<Boolean> setState(@RequestParam String logId, @RequestParam Integer state) {
        boolean result = false;
        try {
            result = memberService.setState(logId, state);
        } catch (Exception e) {
