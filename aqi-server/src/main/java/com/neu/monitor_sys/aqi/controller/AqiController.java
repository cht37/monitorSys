package com.neu.monitor_sys.aqi.controller;
...
public class AqiController {
    ...
    public MyResponse<List<AqiDTO>> getAqiLevelByValue(@RequestParam Integer SO2,@RequestParam Integer CO,@RequestParam Integer SPM){
        List<AqiDTO> aqiDTO;
        try {
